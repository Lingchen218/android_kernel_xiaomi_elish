...
TOOLCHAIN_PATH=$TOOLCHAIN_PATH:$HOME/aarch64-linux-android-4.9/bin:$HOME/arm-linux-androideabi-4.9/bin:$HOME/aarch64-linux-gnu/bin:$HOME/arm-linux-gnueabi/bin
